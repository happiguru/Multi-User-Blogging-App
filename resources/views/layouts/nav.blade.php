    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link nav-link-anchor" href="{{ route('blogs.create') }}">Create blog</a>
                    </li>
                @endguest
            </ul>
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('blogs')}}">Blogs <span class="badge bg-dark text-white">{{ $blog->count() }}</span></a>
